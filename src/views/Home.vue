            ...
            <ul class="navbar-nav mr-auto">
              <li class="nav-item dropdown">
                <a
                  ...
                  data-toggle="dropdown"
                >Language</a>
                <ul class="dropdown-menu small border-0 shadow">
                  <li class v-for="language in languages" :key="language.title">
                    <a class="dropdown-item" href="#">{{language.title}}</a>
                  </li>
                </ul>
              </li>
              <li class="nav-item dropdown">
...
export default {
  ...
  data() {
    return {
      ...
      items: [{ title: "Naira" }, { title: "Cedi" }],
      menus: [
        { icon: "", item: "All Category" },
        { icon: "", item: "Protein" },
        { icon: "", item: "Grains" },
        { icon: "", item: "Vegetable" },
        { icon: "", item: "Oil" }
...
.bg-img {
  ...
  background-image: linear-gradient(
    ...
    url("../assets/images/banners/beef.jpg");
  background-position: 0px 0px, 50% 50%;
